...
namespace EmailBot.Bots
{
    public class EmailBot : TeamsActivityHandler
    {
        ...
        public EmailBot(IConversationReferenceHelper conversationReferencesHelper, BotDbContext context, IEmailPromptHelper emailPromptHelper)
        {
